...
function Home() {
  ...
  const fetchItems = async () => {
    const response = await axios.get(
      "https://fbbackend-server.onrender.com/api/homes"
    );
  ...
  const handleAdd = async () => {
    ...
    try {
      await axios.post("https://fbbackend-server.onrender.com/api/home", data, {
        headers: {
  ...
  const handleUpdate = async () => {
    ...
    try {
      await axios.put(
        `https://fbbackend-server.onrender.com/api/home/${editIndex}`,
        data,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(
        `https://fbbackend-server.onrender.com/api/home/${id}`
      );
