...
function General() {
  ...
  const fetchItems = async () => {
    const response = await axios.get(
      "https://fbbackend-server.onrender.com/organization/general"
    );
  ...
  const handleUpdate = async () => {
    ...
    try {
      await axios.put(
        `https://fbbackend-server.onrender.com/organization/general/${editIndex}`,
        data,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(
        `https://fbbackend-server.onrender.com/organization/general/${id}`
      );
            ...
            {items.map((item, index) => (
              <tr key={item._id}>
                ...
                <td>
                  {" "}
                  <img
                    src={`https://fbbackend-server.onrender.com/general/${item.image
                      .split("/")
                      .pop()}`}
                    alt="Item"
                    style={{ width: "80px" }}
