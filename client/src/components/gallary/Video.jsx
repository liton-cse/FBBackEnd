...
function Videos() {
  ...
  const fetchItems = async () => {
    const response = await axios.get(
      "https://fbbackend-server.onrender.com/gallary/videos"
    );
  ...
  */
  const handleDelete = async (id) => {
    try {
      await axios.delete(
        `https://fbbackend-server.onrender.com/gallary/videos/${id}`
      );
              ...
              <tr key={item._id}>
                ...
                <td>
                  <video width="100" height="60" controls>
                    <source
                      src={`https://fbbackend-server.onrender.com/videos/${item.district}/${item.subDistrict}/${item.videoUpd}`}
                      type="video/mp4"
                    />
                  </video>
                </td>
          ...
          <Modal.Body className="modal-body">
            <Form>
              ...
              <Form.Group controlId="formSubDistrict">
                <Form.Label className="form-label">Upazila:</Form.Label>
                <Form.Control
                  type="text"
                  name="subDistrict"
              ...
              <Form.Group controlId="formVideo" className="mt-3">
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, video: e.target.files })
                  }
                />
              </Form.Group>
            </Form>
